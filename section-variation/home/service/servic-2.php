...
<div class="container wow fadeInDown" data-wow-delay="1s">
	...
	?>
		...
		<?php } else { $defalt_arg =array('class' => "img-responsive");
    ...
    if (get_the_title()) {
?>		
				<h2><a href="<?php echo $meta_service_link; ?>" <?php  if(get_post_meta( get_the_ID(),'meta_service_target', true )) { echo "target='_blank'"; }  ?> > <?php echo the_title(); ?> </a></h2><?php } ?>
				...
				<?php if(get_post_meta( get_the_ID(),'service_readmore_text', true )):?><div class="service-btn"><a href="<?php echo $meta_service_link; ?>" <?php  if(get_post_meta( get_the_ID(),'meta_service_target', true )) { echo "target='_blank'"; }  ?> ><?php echo get_post_meta( get_the_ID(),'service_readmore_text', true );  ?></a></div><?php endif;?>
			</div>	
		</div>
		<?php if($j%$total_services==0){ echo "<div class='clearfix'></div>"; } $j++; endwhile;
	} else {
