...
global $template;
if(basename($template)!='testimonial-grid-2.php')
{
$test_col=12;
}
else
...
<?php endif;?>
<!-- Testimonial Section -->
	<div class="testimonial-section testimonial1" style="background: url('<?php echo $current_options['testi_background']; ?>'); background-size:cover;">
		<div class="overlay">
			<div class="container">
				<div class="row" <?php if(basename($template)!='testimonial-grid-2.php'):?> id="testimonial-scroll" <?php endif;?>>
						<?php 
