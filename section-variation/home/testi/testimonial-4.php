...
global $template;
if(basename($template)!='testimonial-grid-4.php')
{
$test_col=12;
}
else
...
<?php endif;?>
<!-- Testimonial Section -->
	<div class="testimonial-section testimonial3" style="background: url('<?php echo $current_options['testi_background']; ?>'); background-size:cover;">
		<div class="overlay">
			<div class="container">
				<div class="row" <?php if(basename($template)!='testimonial-grid-4.php'):?> id="testimonial-scroll" <?php endif;?>>
						<?php 
						...
						?>
						<?php if(basename($template)=='testimonial-grid-4.php')
						{
						?>
						...
						?>
							<div><img class="img-circle img-responsive" alt="Wallstreet Image" src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/testi<?php echo $i;?>.jpg"></div>
