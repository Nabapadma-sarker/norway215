 ...
 * @file         :	single-wallstreet_service.php
 * @package      :	wallstreet-Pro
  @author       :	webriti
 * @filesource   :	wp-content/themes/wallstreet/single-wallstreet_service.php
 */
get_header();
                        ...
                        <div class="blog-post-title">
                            <?php if ($current_options['archive_page_meta_section_settings'] == false) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php
                                    echo '<p>' . get_post_meta(get_the_ID(), 'service_description_text', true) . '</p>';
                                    ?>
